...
class ShoppingCart {
  ...
  set cartItems(value) {
    this.items = value;
    console.log(value);
    // Here this.totalAmount invoke getter method
  ...
  addProduct(product) {
    ...
    // Here "this.cartItems =" invoke setter method and value as "updatedItems"
    // Why we are saying setters are called ?
